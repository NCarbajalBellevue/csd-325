...
# Purpose: Modified Cho-Han game

# Changes Made:
# 1. Changed input prompts to NC:
# 2. Changed house fee from 10% to 12%
# 3. Added notice about 10 mon bonus for totals of 2 or 7
# 4. Added 10 mon bonus feature
...
while True:  # Main game loop.
    ...
    # Calculate total and award bonus if total is 2 or 7.
    total = dice1 + dice2
